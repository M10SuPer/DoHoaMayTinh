// Nhan_Lab4_Bai2.cpp : Defines the entry point for the console application.
//
...
void Display();
void Init();
void Reshape(int witch, int height);
void Idle();
...
void Special(int key, int, int)
{
	...
	case GLUT_KEY_LEFT:
		moveDirection = MOVE_LEFT;
		angle = TURN_LEFT; break;
	case GLUT_KEY_RIGHT:
		moveDirection = MOVE_RIGHT;
		angle = TURN_RIGHT; break;
	case GLUT_KEY_UP:
		moveDirection = MOVE_UP;
		angle = TURN_UP; break;
	case GLUT_KEY_DOWN:
		moveDirection = MOVE_DOWN;
		angle = TURN_DOWN; break;
	}
	glutPostRedisplay();
}
